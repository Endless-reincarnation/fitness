...
function toCloudSession(session) {
  return {
    ...
    completed_set_count: session.completedSetCount || session.setCount,
    total_volume: session.totalVolume,
    body_weight_kg: session.bodyWeightKg,
    density_level: session.densityLevel,
    density_label: session.densityLabel,
    density_factor: session.densityFactor,
    sets_per_minute: session.setsPerMinute,
    estimated_calories: session.estimatedCalories,
    calorie_hint: session.calorieHint,
    calorie_formula_version: session.calorieFormulaVersion,
    duration_capped: Boolean(session.durationCapped),
...
function fromCloudSession(record) {
  return {
    ...
    completedSetCount: record.completed_set_count || record.set_count,
    totalVolume: record.total_volume,
    bodyWeightKg: record.body_weight_kg,
    densityLevel: record.density_level,
    densityLabel: record.density_label,
    densityFactor: record.density_factor,
    setsPerMinute: record.sets_per_minute,
    estimatedCalories: record.estimated_calories,
    calorieHint: record.calorie_hint,
    calorieFormulaVersion: record.calorie_formula_version,
    durationCapped: Boolean(record.duration_capped),
